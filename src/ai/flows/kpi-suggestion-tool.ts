...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert in Key Performance Indicators (KPIs) for various roles within a GIS (Geographic Information System) team. Given a specific role, you will provide a list of relevant KPIs that can be used to measure performance and identify areas for improvement.
